...
<link rel="canonical" href="https://axcis.co.jp/contact/recruit/check.php">
...
"position": 3,
"item": {
"@id": "https://axcis.co.jp/contact/recruit/check.php",
"name": "入力内容の確認画面"
}
}]
}
...
<ul>
<li class="headerLinkBtn basicBtn"><a href="../partner/"><i class="fa fa-user" aria-hidden="true"></i>ビジネスパートナーのご相談はこちら</a></li>
<li class="headerLinkBtn recEntryBtn"><a href="../recruit/">
...
<li><a href="../../company/">会社概要</a></li>
<li><a href="../../recruit/">採用情報</a></li>
<li><a href="../" class="navActive">お問い合せ</a></li>
</ul>
</nav>
</header>
...
<p class="spNone contact-h">お電話でのお問い合せ<span class="contactTel tb-contactTel br"> <i class="fa fa-phone" aria-hidden="true"></i>03-5829-6475</span><span class="tel-info">平日9:30-18:30</span></p>
<p id="head-spTel" class="pcNone contact-h">お電話でのお問い合せ<br><a href="tel:0358296475"><span class="head-contactTel"><i class="fa fa-phone" aria-hidden="true"></i>03-5829-6475</span></a><span class="head-tel-info">平日9:30-18:30</span></p>
<p id="check-msg" class="contact-hp">下記の内容でお間違いなければ、<span class="br">送信ボタンを押して下さい。</span></p>
</div>
...
<dt>ご年齢</dt>
<dd><?php echo html($_SESSION['age']); ?></dd>
<dt>性別</dt>
<dd><?php echo html($_SESSION['gender']); ?></dd>
<dt>メールアドレス</dt>
<dd><?php echo html($_SESSION['email']); ?></dd>
<dt>TEL</dt>
<dd><?php echo html($_SESSION['tel']); ?></dd>
<dt>現在の状況</dt>
<dd><?php echo html($_SESSION['works']); ?></dd>
<dt>ご希望の雇用形態</dt>
<dd><?php echo html($_SESSION['jobcategory']); ?></dd>
<dt>ご希望の職種</dt>
<dd><?php echo html($_SESSION['jobpattern']); ?></dd>
<dt>お問い合せ内容</dt>
