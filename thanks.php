...
<body id="thanks-page">
	...
	<div id="thanks-msg"><p>この度は株式会社アクシスへお問い合わせ頂き、誠にありがとうございました。お送り頂いた内容を確認し、担当より折り返しご連絡いたしますので、今しばらくお待ち下さい。また、お問い合わせの内容により、回答までに少々お時間を頂く場合がございますのでご了承下さい。</p>
	...
	<p class="alert-telinfo ja"><i class="fa fa-phone" aria-hidden="true"></i>03-5829-6475</p>
